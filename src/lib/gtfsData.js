...
export const SUBWAY_STOPS = [
  ...
  // F line (Culver — Manhattan & Brooklyn)
  { stop_id: 'F01', stop_name: 'Jamaica-179 St', routes: ['F'], stop_lat: 40.712646, stop_lon: -73.783817 },
  { stop_id: 'F09', stop_name: 'Forest Hills-71 Av', routes: ['E','F','M','R'], stop_lat: 40.721567, stop_lon: -73.844849 },
  { stop_id: 'F14', stop_name: 'Roosevelt Av-Jackson Hts', routes: ['E','F','M','R','7'], stop_lat: 40.746644, stop_lon: -73.891338 },
  { stop_id: 'F18', stop_name: 'Queens Plaza', routes: ['E','M','R'], stop_lat: 40.748973, stop_lon: -73.937243 },
  { stop_id: 'F20', stop_name: 'Lexington Av-63 St', routes: ['F','Q'], stop_lat: 40.764629, stop_lon: -73.966113 },
  { stop_id: 'D15', stop_name: '47-50 Sts-Rockefeller Ctr', routes: ['B','D','F','M'], stop_lat: 40.758663, stop_lon: -73.981329 },
  { stop_id: 'D16', stop_name: '42 St-Bryant Pk', routes: ['B','D','F','M'], stop_lat: 40.754222, stop_lon: -73.984569 },
  { stop_id: 'D18', stop_name: '23 St', routes: ['F','M'], stop_lat: 40.742878, stop_lon: -73.992821 },
  { stop_id: 'D19', stop_name: '14 St', routes: ['F','M'], stop_lat: 40.738228, stop_lon: -73.996209 },
  { stop_id: 'D20', stop_name: 'W 4 St-Wash Sq', routes: ['A','B','C','D','E','F','M'], stop_lat: 40.732338, stop_lon: -74.000495 },
  { stop_id: 'D21', stop_name: 'Broadway-Lafayette St', routes: ['B','D','F','M'], stop_lat: 40.725297, stop_lon: -73.996204 },
  { stop_id: 'D22', stop_name: 'Grand St', routes: ['B','D'], stop_lat: 40.71834, stop_lon: -73.993819 },
  { stop_id: 'F15', stop_name: '2 Av', routes: ['F'], stop_lat: 40.723402, stop_lon: -73.989938 },
  { stop_id: 'F16', stop_name: 'Delancey St-Essex St', routes: ['F','J','M','Z'], stop_lat: 40.71872, stop_lon: -73.987531 },
  { stop_id: 'F17', stop_name: 'East Broadway', routes: ['F'], stop_lat: 40.713855, stop_lon: -73.990173 },
  { stop_id: 'F18B', stop_name: 'York St', routes: ['F'], stop_lat: 40.701397, stop_lon: -73.986751 },
  { stop_id: 'F20B', stop_name: 'Jay St-MetroTech', routes: ['A','C','F','R'], stop_lat: 40.692338, stop_lon: -73.987342 },
  { stop_id: 'F21', stop_name: 'Bergen St', routes: ['F','G'], stop_lat: 40.686145, stop_lon: -73.990862 },
  { stop_id: 'F22', stop_name: 'Carroll St', routes: ['F','G'], stop_lat: 40.680303, stop_lon: -73.99504 },
  { stop_id: 'F23', stop_name: 'Smith-9 Sts', routes: ['F','G'], stop_lat: 40.673581, stop_lon: -73.995959 },
  { stop_id: 'F24', stop_name: '4 Av-9 St', routes: ['F','G','R'], stop_lat: 40.670272, stop_lon: -73.989779 },
  { stop_id: 'F25', stop_name: '7 Av', routes: ['F','G'], stop_lat: 40.666271, stop_lon: -73.980305 },
  { stop_id: 'F26', stop_name: '15 St-Prospect Park', routes: ['F','G'], stop_lat: 40.660365, stop_lon: -73.979493 },
  { stop_id: 'F27', stop_name: 'Fort Hamilton Pkwy', routes: ['F','G'], stop_lat: 40.650782, stop_lon: -73.975776 },
  { stop_id: 'F28', stop_name: 'Church Av', routes: ['F','G'], stop_lat: 40.644041, stop_lon: -73.979678 },
  { stop_id: 'F29', stop_name: 'Ditmas Av', routes: ['F'], stop_lat: 40.636119, stop_lon: -73.978172 },
  { stop_id: 'F30', stop_name: '18 Av', routes: ['F'], stop_lat: 40.629755, stop_lon: -73.976971 },
  { stop_id: 'F31', stop_name: 'Avenue I', routes: ['F'], stop_lat: 40.625322, stop_lon: -73.976127 },
  { stop_id: 'F32', stop_name: 'Bay Pkwy', routes: ['F'], stop_lat: 40.620769, stop_lon: -73.975264 },
  { stop_id: 'F33', stop_name: 'Avenue N', routes: ['F'], stop_lat: 40.615444, stop_lon: -73.974197 },
  { stop_id: 'F34', stop_name: 'Avenue P', routes: ['F'], stop_lat: 40.608944, stop_lon: -73.973022 },
  { stop_id: 'F35', stop_name: 'Kings Hwy', routes: ['F'], stop_lat: 40.603217, stop_lon: -73.972361 },
  { stop_id: 'F36', stop_name: 'Avenue U', routes: ['F'], stop_lat: 40.596063, stop_lon: -73.973357 },
  { stop_id: 'F38', stop_name: 'Avenue X', routes: ['F'], stop_lat: 40.589449, stop_lon: -73.974576 },
  { stop_id: 'F39', stop_name: 'Neptune Av', routes: ['F'], stop_lat: 40.581011, stop_lon: -73.974574 },
  { stop_id: 'F40', stop_name: 'W 8 St-NY Aquarium', routes: ['F','Q'], stop_lat: 40.576127, stop_lon: -73.975939 },
