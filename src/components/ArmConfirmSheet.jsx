      ...
      {open && stop && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-[calc(4rem+env(safe-area-inset-bottom))] left-0 right-0 z-50 bg-card border-t border-border rounded-t-3xl p-6 max-w-md mx-auto max-h-[75vh] overflow-y-auto"
          >
